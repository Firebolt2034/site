    ...
    const answer ={
      data(){
        return{
          show:true,
          z:'<p>Решение.</p>',
          k:'<p>Под маршрутом следует понимать порядок посещения курьером училищ. Пронумеруем училища номерами от 1 до 7, тогда маршрут будет представляться последовательностью из 7 Цифр, порядок которых может меняться. Количество маршрутов равно числу перестановок из 7 элементов: Р<sub>7</sub>= 7! = 5 040.</p>'
        }
      }
    }
