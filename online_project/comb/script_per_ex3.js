    ...
    const answer ={
      data(){
        return{
          show:true,
          z:'<p>Решение.</p>',
          k:'<p>Всего 7 мальчиков на 7 местах, но один элемент фиксирован, не переставляется (Степа находится в конце ряда). Число возможных комбинаций при этом равно числу перестановок 6 мальчиков, стоящих перед Степой: Р<sub>6</sub>=6! = 720.'
        }
      }
    }
