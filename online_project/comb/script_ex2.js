    ...
    const otvet={
      data(){
        return{
          ...
          y:'pod_vis',
          t:'<a href="index_comb_ex3.html"><button class="but_ex1"   v-if="show">К следующему заданию</button></a>'
    ...
    const answer ={
      data(){
        return{
          show:true,
          z:'<p>Решение.</p>',
          k:'<p>По условию задачи последовательно осуществляются три выбора, но каждый выбор - из своего множества вариантов; поэтому выборы независимы, а каждая выбираемая тройка блюд оказывается упорядоченной (первое - второе - третье). По правилу произведения общее число способов выбрать обед равно 3*5*2=30. </p>'
        }
      }
    }
