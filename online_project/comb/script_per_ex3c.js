    ...
    const answer ={
      data(){
        return{
          show:true,
          z:'<p>Решение.</p>',
          k:'<p>Пусть теперь Степа и Виталик стоят рядом в порядке ВС. Тогда получим еще Р<sub>6</sub> = 6! = 720 других комбинаций.</p><p>Общее число комбинаций, в которых Степа и Виталик стоят рядом (в любом порядке) равно 720 + 720 = 1 440.</p>'
        }
      }
    }
