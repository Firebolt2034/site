    ...
    const otvet={
      data(){
        return{
          ...
          y:'pod_vis',
          t:'<a href="index_comb_ex3d.html"><button class="but_ex1"   v-if="show">К следующему заданию</button></a>'
    ...
    const answer ={
      data(){
        return{
          show:true,
          z:'<p>Решение.</p>',
          k:'<p>Если фиксировать цвет нижней полосы, то цвета трех расположенных над ней полос можно выбрать 3 &#215 2 &#215 1 =6 разными способами; получаем 6 флагов с нижней зеленой полосой.</p>'
        }
      }
    }
