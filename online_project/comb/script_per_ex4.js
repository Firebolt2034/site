    ...
    const answer ={
      data(){
        return{
          show:true,
          z:'<p>Решение.</p>',
          k:'<p>После командира и заместителя третий игрок может выбрать любое из 9 оставшихся мест, следующий - из 8, и т. д. Общее число способов построения по правилу произведения равно: P<sub>9</sub> = 9! = 362880.</p>'
        }
      }
    }
